...
class Roles extends $pb.ProtobufEnum {
  static const Roles INVALID = Roles._(
      0,
      const $core.bool.fromEnvironment('protobuf.omit_enum_names')
          ? ''
          : 'INVALID');
  static const Roles GUEST = Roles._(
      1,
      const $core.bool.fromEnvironment('protobuf.omit_enum_names')
          ? ''
          : 'GUEST');
  static const Roles USER = Roles._(
      2,
      const $core.bool.fromEnvironment('protobuf.omit_enum_names')
          ? ''
          : 'USER');
  static const Roles ADMIN = Roles._(
      3,
      const $core.bool.fromEnvironment('protobuf.omit_enum_names')
          ? ''
          : 'ADMIN');
  static const Roles SUPERADMIN = Roles._(
      4,
      const $core.bool.fromEnvironment('protobuf.omit_enum_names')
          ? ''
          : 'SUPERADMIN');
  ...
  static final $core.Map<$core.int, Roles> _byValue =
